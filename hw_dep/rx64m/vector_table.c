...
#define OFS_OSIC __attribute__ ((section (".ofs2"))) /* 0x00120050 */
#define OFS_REG  __attribute__ ((section (".ofs3"))) /* 0x00120064 */

const unsigned long __SPCCreg OFS_SPCC = 0xffffffff;

// OSIC register (ID codes)
const unsigned long __OSISreg[4] OFS_OSIC = { 0xffffffff, 0xffffffff,
