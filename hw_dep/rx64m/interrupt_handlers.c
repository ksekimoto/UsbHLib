...
//;0x0080  D0FIFO2
void __attribute__ ((weak)) INT_Excep_USBA_D0FIFO2(void)
{
}

//;0x0084  D1FIFO2
void __attribute__ ((weak)) INT_Excep_USBA_D1FIFO2(void)
{
}
...
//;0x00B8  SSITX0
void __attribute__ ((weak)) INT_Excep_SSI0_SSITXI0(void)
{
}

//;0x00BC  SSIRX0
void __attribute__ ((weak)) INT_Excep_SSI0_SSIRXI0(void)
{
}

//;0x00C0  SSIRTI1
void __attribute__ ((weak)) INT_Excep_SSI1_SSIRTI1(void)
{
}
//;0x00C4  Reserved

//;0x00C8  IDEI
void __attribute__ ((weak)) INT_Excep_SRC_IDEI(void)
{
}

//;0x00CC  ODFI
void __attribute__ ((weak)) INT_Excep_SRC_ODFI(void)
{
}
...
//;0x0190 RXIF8
void __attribute__ ((weak)) INT_Excep_SCIFA8_RXIF8(void)
{
}

//;0x0194 TXIF8
void __attribute__ ((weak)) INT_Excep_SCIFA8_TXIF8(void)
{
}

//;0x0198 RXIF9
void __attribute__ ((weak)) INT_Excep_SCIFA9_RXIF9(void)
{
}

//;0x019C TXIF9
void __attribute__ ((weak)) INT_Excep_SCIFA9_TXIF9(void)
{
}

//;0x01A0 RXIF10
void __attribute__ ((weak)) INT_Excep_SCIFA10_RXIF10(void)
{
}

//;0x01A4 TXIF10
void __attribute__ ((weak)) INT_Excep_SCIFA10_TXIF10(void)
{
}
...
//;0x01C8 RXIF11
void __attribute__ ((weak)) INT_Excep_SCIFA11_RXIF11(void)
{
}

//;0x01CC TXIF11
void __attribute__ ((weak)) INT_Excep_SCIFA11_TXIF11(void)
{
}
...
//;0x01F4 OST
void __attribute__ ((weak)) INT_Excep_OST_OST(void)
{
}
