...
#define disk_initialize	uh_disk_initialize
#define	disk_status	uh_disk_status
#define disk_read	uh_disk_read
#define disk_write	uh_disk_write
#define disk_ioctl	uh_disk_ioctl
